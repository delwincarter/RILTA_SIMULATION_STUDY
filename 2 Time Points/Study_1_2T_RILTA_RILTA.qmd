...
### Step 8: Combine All CSV Files into One Data Frame From the new data
...
### Step 9: Scrape Rows and Process Data
...
### Step 10: Convert Logits to Probabilities and Add Actual (Population) Values and flag violations
...
## STEP 13: DELETE CASES WITH ERRORS
...
#### Step 14: Part 1 Create Column Names from the Filename
...
#### Step 14: Part 2 Calculate Violation Percentages per Condition
...
#### Step 14: Part 3 Summarize & Visualize Label Switching Percentage Results
...
# \*\* Step 15: Delete Cases that Violate\*\*
...
### **Step 16: Compute Monte Carlo (MC) Values**
...
### **Step 18: Subset Data for Movers and Stayers**
...
### **Step 19: Combined Plot for Mover and Stayer**
...
### **Step 20: Prepare Data for Heatmaps**
...
### **Step 21: Heatmap Creation and Rendering**
