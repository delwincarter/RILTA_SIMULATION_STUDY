...
subtitle: "*Study 1: LTA Generated, LTA Analyzed with Two Timepoints*"
format:
  html:
    toc: true
    toc-depth: 3
...
### Convert Logits to Probabilities and Add Actual (Population) Values
...
### **Plot Random Sample of Violators for Visual Inspection**
...
#### Part 1 Merge errors with main data
...
#### Part 2 Create Column Names from the Filename
...
#### Part 3 Calculate Violation Percentages per Condition
...
#### Part 4 Summarize & Visualize Label Switching Percentage Results
...
### Scrape Rows and Process Data 2
...
### Convert Logits to Probabilities and Add Actual (Population) Values 2
...
### **Summarize Errors and Violations**
...
# Step 4: Parallelized Processing (Windows/Mac/Linux Compatible)
output_folder <- here('Simulations', 'STUDY_1', '2 Time Points', "1_2T_LTA_GEN_LTA_ANALYZED_REP")  # Adjust to your folder path
file_list <- list.files(output_folder, pattern = "\\.out$", full.names = TRUE)
...
##### Create Final Data Set for Visualization
...
### **Calculate Dichotomous Variables and Bias**
...
### **Subset Data for Movers and Stayers**
...
### **Combined Plot for Mover and Stayer**
...
### **Heatmap Creation and Rendering**

*Create heatmap function to prepare for heatmap creation*
