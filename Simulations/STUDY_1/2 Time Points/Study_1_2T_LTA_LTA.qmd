...
output_folder <- here('Simulations', 'STUDY_1', '3 Time Points', "5_3T_LTA_GEN_LTA_ANALYZED")  # Adjust to your folder path
...
# Step 4: Parallelized Processing (Windows/Mac/Linux Compatible)
output_folder <- here('Simulations', 'STUDY_1', '3 Time Points', "5_3T_LTA_GEN_LTA_ANALYZED_REP")  # Adjust to your folder path
file_list <- list.files(output_folder, pattern = "\\.out$", full.names = TRUE)
