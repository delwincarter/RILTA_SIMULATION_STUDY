...
subtitle: "*Study 1: LTA Generated, RILTA Analyzed with Two Timepoints*"
format:
  html:
    toc: true
    toc-depth: 3
...
# Will returen final_combined_data dataframe
```
...
output_folder <- here('Simulations', 'STUDY_1', '2 Time Points', "2_2T_LTA_GEN_RILTA_ANALYZED")  # Adjust to your folder path
...
# Step 4: Parallelized Processing (Windows/Mac/Linux Compatible)
output_folder <- here('Simulations', 'STUDY_1', '2 Time Points', "2_2T_LTA_GEN_RILTA_ANALYZED_REP")  # Adjust to your folder path
file_list <- list.files(output_folder, pattern = "\\.out$", full.names = TRUE)
