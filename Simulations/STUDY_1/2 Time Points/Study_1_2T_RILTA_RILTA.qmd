...
output_folder <- here('Simulations', 'STUDY_1', '2 Time Points', '4_RILTA_GEN_RILTA_ANALYZED')  # Adjust to your folder path
...
rilta_rilta_func <- function(N_numeric, TPs, Lambda, Replications_Needed) {
  ...
  RILTA_RILTA_Model<- mplusModeler(RILTA_RILTA, 
                                   ...
                                   modelout = glue(here('Simulations', 'STUDY_1', '2 Time Points', '4_2T_RILTA_GEN_RILTA_ANALYZED', "RILTA_RILTA_N_{N_numeric}_TP_{TPs}_TH_1_Lambda_{Lambda}.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
return(RILTA_RILTA_Model)
}
...
# Step 4: Parallelized Processing (Windows/Mac/Linux Compatible)
output_folder <- here('Simulations', 'STUDY_1', '2 Time Points', '4_RILTA_GEN_RILTA_ANALYZED_REP')  # Adjust to your folder path
file_list <- list.files(output_folder, pattern = "\\.out$", full.names = TRUE)
