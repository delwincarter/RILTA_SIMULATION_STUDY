...
create_plot <- function(data, title_suffix) {
  ...
  ggplot(data = data, aes(x = factor(N))) +  
    ...
    geom_point(aes(y = Parameter_Bias, color = "Parameter Bias"), shape = 16, size = 1.5, fill = "#7030A0", alpha = 0.8) +  
    geom_point(aes(y = SE_Bias, color = "Standard Error Bias"), shape = 18, size = 1.5, fill = "#C830CC", alpha = 0.8) +  
...
create_plot <- function(data, title_suffix) {
  ggplot(data = data, aes(x = factor(N))) +  
    ...
    geom_point(aes(y = Parameter_Bias, color = "Parameter Bias"), shape = 16, size = 1.5, fill = "#7030A0", alpha = 0.8) +  
    geom_point(aes(y = SE_Bias, color = "Standard Error Bias"), shape = 18, size = 1.5, fill = "#C830CC", alpha = 0.8) +  
    geom_point(data = subset(data, Coverage_Dic == 0), aes(y = Parameter_Bias, color = "Coverage Failure"), shape = NA, size = 1.5, fill = "#7030A0", alpha = 0.8) +  
    geom_point(data = subset(data, Power_Dic == 0), aes(y = Parameter_Bias, color = "Power Failure"), shape = NA, size = 1.5, fill = "black", alpha = 0.8) + 
    geom_line(data = subset(data, Coverage_Dic == 0), aes(y = Parameter_Bias, color = "Coverage Failure", group = Population_Label), linewidth = 0.3, linetype = "solid") +
    geom_line(data = subset(data, Power_Dic == 0), aes(y = Parameter_Bias, color = "Power Failure", group = Population_Label), linewidth = 0.3, linetype = "solid") +
    scale_color_manual(
      values = c("Parameter Bias" = "#7030A0", "Standard Error Bias" = "#C830CC", "Coverage Failure" = "#7030A0", "Power Failure" = "black"), 
...
# Further operations on gt_table
gt_table |> tab_options(table.width = pct(65)) |> gtsave(here('Simulations', 'STUDY_1', '3 Time Points', "zHEATMAPS", "z3t_heatmaps", "z3t_l_l_heatmaps", "3T_L_L.png", expand = 8))
