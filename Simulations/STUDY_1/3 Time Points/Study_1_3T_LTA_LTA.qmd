...
subtitle: "*Study 1: LTA Generated, LTA Analyzed with Three Timepoints*"
format:
  html:
    toc: true
    toc-depth: 3
...
output_folder <- here('Simulations', 'STUDY_1', '3 Time Points', "5_2T_LTA_GEN_LTA_ANALYZED")  # Adjust to your folder path
...
*Create gt function to generate plots*
...
*Create heat map ion function using the `gt` package*
