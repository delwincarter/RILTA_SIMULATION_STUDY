...
output_folder <- here('Simulations', 'STUDY_1', '3 Time Points', '6_3T_LTA_GEN_RILTA_ANALYZED')  # Adjust to your folder path
...
violation_summary <- final_data_with_actuals %>%
  ...
  select(
    FileName,Population, N, N_numeric, Total_Rows, Total_Violations, Total_Errors,
...
# Step 4: Parallelized Processing (Windows/Mac/Linux Compatible)
output_folder <- here('Simulations', 'STUDY_1', '3 Time Points', '6_3T_LTA_GEN_RILTA_ANALYZED_REP')  # Adjust to your folder path
file_list <- list.files(output_folder, pattern = "\\.out$", full.names = TRUE)
