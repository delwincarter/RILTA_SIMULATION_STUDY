...
subtitle: "Study 1.8: RILTA Generated, RILTA Analyzed with Three Timepoints"
...
rilta_rilta_func <- function(N, TPs, lambda) {
  ...
  RILTA_RILTA_Model<- mplusModeler(RILTA_RILTA, 
                                   dataout = here('Simulations', 'STUDY_1', '3 Time Points', '8_3T_RILTA_GEN_RILTA_ANALYZED', glue("RILTA_RILTA_N_{N}_TP_{TPs}_TH_1_lambda_{lambda}.dat")),
                                   modelout = glue(here('Simulations', 'STUDY_1', '3 Time Points', '8_3T_RILTA_GEN_RILTA_ANALYZED', "RILTA_RILTA_N_{N}_TP_{TPs}_TH_1_lambda_{lambda}.inp")),
...
save_as_image(ft_200, here("Simulations", "STUDY_1", "3 Time Points", "zErrors", "3t_r_r_e&v_200.svg"))
save_as_image(ft_300, here("Simulations", "STUDY_1", "3 Time Points", "zErrors", "3t_r_r_e&v_300.svg"))
save_as_image(ft_400, here("Simulations", "STUDY_1", "3 Time Points", "zErrors", "3t_r_r_e&v_400.svg"))
save_as_image(ft_600, here("Simulations", "STUDY_1", "3 Time Points", "zErrors", "3t_r_r_e&v_600.svg"))
save_as_image(ft_700, here("Simulations", "STUDY_1", "3 Time Points", "zErrors", "rt_r_r_e&v_700.svg"))
save_as_image(ft_800, here("Simulations", "STUDY_1", "3 Time Points","zErrors", "3t_r_r_e&v_800.svg"))
...
# Save each flextable as an SVG file
save_as_image(ft_200, here("Simulations", "STUDY_1", "3 Time Points", "zErrors", "z3t_r_r_e&v_200_final.svg"))
save_as_image(ft_300, here("Simulations", "STUDY_1", "3 Time Points", "zErrors", "z3t_r_r_e&v_300_final.svg"))
save_as_image(ft_400, here("Simulations", "STUDY_1", "3 Time Points", "zErrors", "z3t_r_r_e&v_400_final.svg"))
save_as_image(ft_600, here("Simulations", "STUDY_1", "3 Time Points", "zErrors", "z3t_r_r_e&v_600_final.svg"))
save_as_image(ft_700, here("Simulations", "STUDY_1", "3 Time Points", "zErrors", "z3t_r_r_e&v_700_final.svg"))
save_as_image(ft_800, here("Simulations", "STUDY_1", "3 Time Points", "zErrors", "z3t_r_r_e&v_800_final.svg"))
```
...
ggsave(here('Simulations', 'STUDY_1', '3 Time Points', "zFigures", "x3t_rilta_rilta_plots", "plot_mover.svg"), plot = plot_mover_no_title, width = 6, height = 4, dpi = 300, device = "svg")
```
...
ggsave(here('Simulations', 'STUDY_1', '3 Time Points', "zFigures", "x3t_rilta_rilta_plots", "plot_stayer.svg"), plot = plot_stayer_no_title, width = 6, height = 4, dpi = 300, device = "svg")
```
