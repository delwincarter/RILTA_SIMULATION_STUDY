...
lta_lta_func <- function(N_numeric, TPs, Mix, Replications_Needed) {
  ...
  LTA_LTA_Model <- mplusModeler(
    LTA_LTA, 
    dataout = here('Simulations', 'STUDY_2', '1_2T_LTA_GEN_LTA_ANALYZED_REP', glue("LTA_LTA_N_{N_numeric}_TP_{TPs}_M_{Mix}.dat")),
    modelout = glue(here('Simulations', 'STUDY_2', '1_2T_LTA_GEN_LTA_ANALYZED_REP', "LTA_LTA_M1_N_{N_numeric}_TP_{TPs}_M_{Mix}.inp")),
    check = TRUE, run = TRUE, hashfilename = FALSE
  )
...
lta_lta_func2 <- function(N_numeric, TPs, Mix, Replications_Needed) {
  ...
  LTA_LTA_Model2 <- mplusModeler(
    LTA_LTA2, 
    dataout = here('Simulations', 'STUDY_2', '1_2T_LTA_GEN_LTA_ANALYZED_REP', glue("LTA_LTA_M2_N_{N_numeric}_TP_{TPs}_M_{Mix}.dat")),
    modelout = glue(here('Simulations', 'STUDY_2', '1_2T_LTA_GEN_LTA_ANALYZED_REP', "LTA_LTA_M2_N_{N_numeric}_TP_{TPs}_M_{Mix}.inp")),
    check = TRUE, run = TRUE, hashfilename = FALSE
  )
  return(LTA_LTA_Model2)
}
...
lta_lta_func3 <- function(N_numeric, TPs, Mix, Replications_Needed) {
  ...
  # Run Mplus model
  LTA_LTA_Model3 <- mplusModeler(LTA_LTA3, 
                                 dataout = here('Simulations', 'STUDY_2', '1_2T_LTA_GEN_LTA_ANALYZED_REP', glue("LTA_LTA_M3_N_{N_numeric}_TP_{TPs}_M_{Mix}.dat")),
                                 modelout = glue(here('Simulations', 'STUDY_2', '1_2T_LTA_GEN_LTA_ANALYZED_REP', "LTA_LTA_M3_N_{N_numeric}_TP_{TPs}_M_{Mix}.inp")),
                                 check = TRUE, run = TRUE, hashfilename = FALSE)
  return(LTA_LTA_Model3)
}
