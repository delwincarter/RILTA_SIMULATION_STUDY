...
rilta_lta_func <- function(N, TPs, mix, lambda) {
  ...
  RILTA_LTA_Model <- mplusModeler(
    RILTA_LTA, 
    dataout = here("3_RILTA_GEN_LTA_ANLZE", glue("RILTA_LTA_M1_N_{N}_TP_{TPs}_M_{mix}_L_{lambda}.dat")),
    modelout = glue(here("3_RILTA_GEN_LTA_ANLZE", "RILTA_LTA_M1_N_{N}_TP_{TPs}_M_{mix}_L_{lambda}.inp")),
...
rilta_lta_func2 <- function(N, TPs, mix, lambda) {
  ...
  RILTA_LTA_Model2<- mplusModeler(RILTA_LTA2, 
                                   dataout = here("3_RILTA_GEN_LTA_ANLZE", glue("RILTA_LTA_M2_N_{N}_TP_{TPs}_M_{mix}_L_{lambda}.dat")),
                                   modelout = glue(here("3_RILTA_GEN_LTA_ANLZE", "RILTA_LTA_M2_N_{N}_TP_{TPs}_M_{mix}_L_{lambda}.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
...
rilta_lta_func3 <- function(N, TPs, mix, lambda) {
  ...
  RILTA_LTA_Model3<- mplusModeler(RILTA_LTA3, 
                                   dataout = here("3_RILTA_GEN_LTA_ANLZE", glue("RILTA_LTA_M3_N_{N}_TP_{TPs}_M_{mix}_L_{lambda}.dat")),
                                   modelout = glue(here("3_RILTA_GEN_LTA_ANLZE", "RILTA_LTA_M3_N_{N}_TP_{TPs}_M_{mix}_L_{lambda}.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
...
rilta_lta_func4 <- function(N, TPs, mix) {
  ...
  RILTA_LTA_Model4<- mplusModeler(RILTA_LTA4, 
                                   dataout = here("3_RILTA_GEN_LTA_ANLZE", glue("RILTA_LTA_M1_N_{N}_TP_{TPs}_M_{mix}_L_A.dat")),
                                   modelout = glue(here("3_RILTA_GEN_LTA_ANLZE", "RILTA_LTA_M1_N_{N}_TP_{TPs}_M_{mix}_L_A.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
...
rilta_lta_func5 <- function(N, TPs, mix) {
  ...
  RILTA_LTA_Model5<- mplusModeler(RILTA_LTA5, 
                                   dataout = here("3_RILTA_GEN_LTA_ANLZE", glue("RILTA_LTA_M1_N_{N}_TP_{TPs}_M_{mix}_L_B.dat")),
                                   modelout = glue(here("3_RILTA_GEN_LTA_ANLZE", "RILTA_LTA_M1_N_{N}_TP_{TPs}_M_{mix}_L_B.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
...
rilta_lta_func6 <- function(N, TPs, mix) {
  ...
  RILTA_LTA_Model6<- mplusModeler(RILTA_LTA6, 
                                   dataout = here("3_RILTA_GEN_LTA_ANLZE", glue("RILTA_LTA_M1_N_{N}_TP_{TPs}_M_{mix}_L_C.dat")),
                                   modelout = glue(here("3_RILTA_GEN_LTA_ANLZE", "RILTA_LTA_M1_N_{N}_TP_{TPs}_M_{mix}_L_C.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
...
rilta_lta_func7 <- function(N, TPs, mix) {
  ...
  RILTA_LTA_Model7<- mplusModeler(RILTA_LTA7, 
                                   dataout = here("3_RILTA_GEN_LTA_ANLZE", glue("RILTA_LTA_M1_N_{N}_TP_{TPs}_M_{mix}_L_D.dat")),
                                   modelout = glue(here("3_RILTA_GEN_LTA_ANLZE", "RILTA_LTA_M1_N_{N}_TP_{TPs}_M_{mix}_L_D.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
...
rilta_lta_func8 <- function(N, TPs, mix) {
  ...
  RILTA_LTA_Model8<- mplusModeler(RILTA_LTA8, 
                                   dataout = here("3_RILTA_GEN_LTA_ANLZE", glue("RILTA_LTA_M2_N_{N}_TP_{TPs}_M_{mix}_L_A.dat")),
                                   modelout = glue(here("3_RILTA_GEN_LTA_ANLZE", "RILTA_LTA_M2_N_{N}_TP_{TPs}_M_{mix}_L_A.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
...
rilta_lta_func9 <- function(N, TPs, mix) {
  ...
  RILTA_LTA_Model9<- mplusModeler(RILTA_LTA9, 
                                   dataout = here("3_RILTA_GEN_LTA_ANLZE", glue("RILTA_LTA_M2_N_{N}_TP_{TPs}_M_{mix}_L_B.dat")),
                                   modelout = glue(here("3_RILTA_GEN_LTA_ANLZE", "RILTA_LTA_M2_N_{N}_TP_{TPs}_M_{mix}_L_B.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
...
rilta_lta_func10 <- function(N, TPs, mix) {
  ...
  RILTA_LTA_Model10<- mplusModeler(RILTA_LTA10, 
                                   dataout = here("3_RILTA_GEN_LTA_ANLZE", glue("RILTA_LTA_M2_N_{N}_TP_{TPs}_M_{mix}_L_C.dat")),
                                   modelout = glue(here("3_RILTA_GEN_LTA_ANLZE", "RILTA_LTA_M2_N_{N}_TP_{TPs}_M_{mix}_L_C.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
...
rilta_lta_func11 <- function(N, TPs, mix) {
  ...
  RILTA_LTA_Model11<- mplusModeler(RILTA_LTA11, 
                                   dataout = here("3_RILTA_GEN_LTA_ANLZE", glue("RILTA_LTA_M2_N_{N}_TP_{TPs}_M_{mix}_L_D.dat")),
                                   modelout = glue(here("3_RILTA_GEN_LTA_ANLZE", "RILTA_LTA_M2_N_{N}_TP_{TPs}_M_{mix}_L_D.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
...
rilta_lta_func12 <- function(N, TPs, mix) {
  ...
  RILTA_LTA_Model12<- mplusModeler(RILTA_LTA12, 
                                   dataout = here("3_RILTA_GEN_LTA_ANLZE", glue("RILTA_LTA_M3_N_{N}_TP_{TPs}_M_{mix}_L_A.dat")),
                                   modelout = glue(here("3_RILTA_GEN_LTA_ANLZE", "RILTA_LTA_M3_N_{N}_TP_{TPs}_M_{mix}_L_A.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
...
rilta_lta_func13 <- function(N, TPs, mix) {
  ...
  RILTA_LTA_Model13<- mplusModeler(RILTA_LTA13, 
                                   dataout = here("3_RILTA_GEN_LTA_ANLZE", glue("RILTA_LTA_M3_N_{N}_TP_{TPs}_M_{mix}_L_B.dat")),
                                   modelout = glue(here("3_RILTA_GEN_LTA_ANLZE", "RILTA_LTA_M3_N_{N}_TP_{TPs}_M_{mix}_L_B.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
...
rilta_lta_func14 <- function(N, TPs, mix) {
  ...
  RILTA_LTA_Model14<- mplusModeler(RILTA_LTA14, 
                                   dataout = here("3_RILTA_GEN_LTA_ANLZE", glue("RILTA_LTA_M3_N_{N}_TP_{TPs}_M_{mix}_L_C.dat")),
                                   modelout = glue(here("3_RILTA_GEN_LTA_ANLZE", "RILTA_LTA_M3_N_{N}_TP_{TPs}_M_{mix}_L_C.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
...
rilta_lta_func15 <- function(N, TPs, mix) {
  ...
  RILTA_LTA_Model15<- mplusModeler(RILTA_LTA15, 
                                   dataout = here("3_RILTA_GEN_LTA_ANLZE", glue("RILTA_LTA_M3_N_{N}_TP_{TPs}_M_{mix}_L_D.dat")),
                                   modelout = glue(here("3_RILTA_GEN_LTA_ANLZE", "RILTA_LTA_M3_N_{N}_TP_{TPs}_M_{mix}_L_D.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
...
rilta_lta_func <- function(N_numeric, TPs, Lambda, Mix, Adjusted_Replications_Needed) {
  ...
  RILTA_LTA_Model <- mplusModeler(
    RILTA_LTA, 
    dataout = here("3_RILTA_GEN_LTA_ANLZE_REP", glue("RILTA_LTA_M1_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_{Lambda}.dat")),
    modelout = glue(here("3_RILTA_GEN_LTA_ANLZE_REP", "RILTA_LTA_M1_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_{Lambda}.inp")),
    check = TRUE, run = TRUE, hashfilename = FALSE
  )
  return(RILTA_LTA_Model)
}
...
rilta_lta_func2 <- function(N_numeric, TPs, Lambda, Mix, Replications_Needed) {
  ...
  # Run Mplus model
  RILTA_LTA_Model2<- mplusModeler(RILTA_LTA2, 
                                   dataout = here("3_RILTA_GEN_LTA_ANLZE_REP", glue("RILTA_LTA_M2_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_{Lambda}.dat")),
                                   modelout = glue(here("3_RILTA_GEN_LTA_ANLZE_REP", "RILTA_LTA_M2_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_{Lambda}.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
return(RILTA_LTA_Model2)
}
...
rilta_lta_func3 <- function(N_numeric, TPs, Lambda, Mix, Replications_Needed) {
  ...
  # Run Mplus model
  RILTA_LTA_Model3<- mplusModeler(RILTA_LTA3, 
                                   dataout = here("3_RILTA_GEN_LTA_ANLZE_REP", glue("RILTA_LTA_M3_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_{Lambda}.dat")),
                                   modelout = glue(here("3_RILTA_GEN_LTA_ANLZE_REP", "RILTA_LTA_M3_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_{Lambda}.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
return(RILTA_LTA_Model3)
}
...
rilta_lta_func4 <- function(N_numeric, TPs, Mix, Replications_Needed) {
  ...
  # Run Mplus model
  RILTA_LTA_Model4<- mplusModeler(RILTA_LTA4, 
                                   dataout = here("3_RILTA_GEN_LTA_ANLZE_REP", glue("RILTA_LTA_M1_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_A.dat")),
                                   modelout = glue(here("3_RILTA_GEN_LTA_ANLZE_REP", "RILTA_LTA_M1_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_A.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
return(RILTA_LTA_Model4)
}
...
rilta_lta_func5 <- function(N_numeric, TPs, Mix, Replications_Needed) {
  ...
  # Run Mplus model
  RILTA_LTA_Model5<- mplusModeler(RILTA_LTA5, 
                                   dataout = here("3_RILTA_GEN_LTA_ANLZE_REP", glue("RILTA_LTA_M1_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_B.dat")),
                                   modelout = glue(here("3_RILTA_GEN_LTA_ANLZE_REP", "RILTA_LTA_M1_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_B.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
return(RILTA_LTA_Model5)
}
...
rilta_lta_func6 <- function(N_numeric, TPs, Mix, Replications_Needed) {
  ...
  # Run Mplus model
  RILTA_LTA_Model6<- mplusModeler(RILTA_LTA6, 
                                   dataout = here("3_RILTA_GEN_LTA_ANLZE_REP", glue("RILTA_LTA_M1_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_C.dat")),
                                   modelout = glue(here("3_RILTA_GEN_LTA_ANLZE_REP", "RILTA_LTA_M1_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_C.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
return(RILTA_LTA_Model6)
}
...
rilta_lta_func7 <- function(N_numeric, TPs, Mix, Replications_Needed) {
  ...
  # Run Mplus model
  RILTA_LTA_Model7<- mplusModeler(RILTA_LTA7, 
                                   dataout = here("3_RILTA_GEN_LTA_ANLZE_REP", glue("RILTA_LTA_M1_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_D.dat")),
                                   modelout = glue(here("3_RILTA_GEN_LTA_ANLZE_REP", "RILTA_LTA_M1_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_D.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
return(RILTA_LTA_Model7)
}
...
rilta_lta_func8 <- function(N_numeric, TPs, Mix, Replications_Needed) {
  ...
  # Run Mplus model
  RILTA_LTA_Model8<- mplusModeler(RILTA_LTA8, 
                                   dataout = here("3_RILTA_GEN_LTA_ANLZE_REP", glue("RILTA_LTA_M2_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_A.dat")),
                                   modelout = glue(here("3_RILTA_GEN_LTA_ANLZE_REP", "RILTA_LTA_M2_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_A.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
return(RILTA_LTA_Model8)
}
...
rilta_lta_func9 <- function(N_numeric, TPs, Mix, Replications_Needed) {
  ...
  # Run Mplus model
  RILTA_LTA_Model9<- mplusModeler(RILTA_LTA9, 
                                   dataout = here("3_RILTA_GEN_LTA_ANLZE_REP", glue("RILTA_LTA_M2_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_B.dat")),
                                   modelout = glue(here("3_RILTA_GEN_LTA_ANLZE_REP", "RILTA_LTA_M2_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_B.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
return(RILTA_LTA_Model9)
}
...
rilta_lta_func10 <- function(N_numeric, TPs, Mix, Replications_Needed) {
  ...
  # Run Mplus model
  RILTA_LTA_Model10<- mplusModeler(RILTA_LTA10, 
                                   dataout = here("3_RILTA_GEN_LTA_ANLZE_REP", glue("RILTA_LTA_M2_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_C.dat")),
                                   modelout = glue(here("3_RILTA_GEN_LTA_ANLZE_REP", "RILTA_LTA_M2_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_C.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
return(RILTA_LTA_Model10)
}
...
rilta_lta_func11 <- function(N_numeric, TPs, Mix, Replications_Needed) {
  ...
  # Run Mplus model
  RILTA_LTA_Model11<- mplusModeler(RILTA_LTA11, 
                                   dataout = here("3_RILTA_GEN_LTA_ANLZE_REP", glue("RILTA_LTA_M2_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_D.dat")),
                                   modelout = glue(here("3_RILTA_GEN_LTA_ANLZE_REP", "RILTA_LTA_M2_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_D.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
return(RILTA_LTA_Model11)
}
...
rilta_lta_func12 <- function(N_numeric, TPs, Mix, Replications_Needed) {
  ...
  # Run Mplus model
  RILTA_LTA_Model12<- mplusModeler(RILTA_LTA12, 
                                   dataout = here("3_RILTA_GEN_LTA_ANLZE_REP", glue("RILTA_LTA_M3_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_A.dat")),
                                   modelout = glue(here("3_RILTA_GEN_LTA_ANLZE_REP", "RILTA_LTA_M3_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_A.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
return(RILTA_LTA_Model12)
}
...
rilta_lta_func13 <- function(N_numeric, TPs, Mix, Replications_Needed) {
  ...
  # Run Mplus model
  RILTA_LTA_Model13<- mplusModeler(RILTA_LTA13, 
                                   dataout = here("3_RILTA_GEN_LTA_ANLZE_REP", glue("RILTA_LTA_M3_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_B.dat")),
                                   modelout = glue(here("3_RILTA_GEN_LTA_ANLZE_REP", "RILTA_LTA_M3_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_B.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
return(RILTA_LTA_Model13)
}
...
rilta_lta_func14 <- function(N_numeric, TPs, Mix, Replications_Needed) {
  ...
  # Run Mplus model
  RILTA_LTA_Model14<- mplusModeler(RILTA_LTA14, 
                                   dataout = here("3_RILTA_GEN_LTA_ANLZE_REP", glue("RILTA_LTA_M3_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_C.dat")),
                                   modelout = glue(here("3_RILTA_GEN_LTA_ANLZE_REP", "RILTA_LTA_M3_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_C.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
return(RILTA_LTA_Model14)
}
...
rilta_lta_func15 <- function(N_numeric, TPs, Mix, Replications_Needed) {
  ...
  # Run Mplus model
  RILTA_LTA_Model15<- mplusModeler(RILTA_LTA15, 
                                   dataout = here("3_RILTA_GEN_LTA_ANLZE_REP", glue("RILTA_LTA_M3_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_D.dat")),
                                   modelout = glue(here("3_RILTA_GEN_LTA_ANLZE_REP", "RILTA_LTA_M3_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_D.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
return(RILTA_LTA_Model15)
}
...
# Step 1: Set the correct CSV directory
csv_directory <- here('3_RILTA_GEN_LTA_ANALYZED_REP')
...
create_table <- function(subset, transition_probability) {
  ...
  if (any(!(subset$Parameter_Bias >= -9.99 & subset$Parameter_Bias <= 9.99), na.rm = TRUE)) {
    gt_table <- gt_table %>%
      data_color(
        ...
        domain = c(-80, 240)  # Adjust the domain to reflect the range of values
      ) %>%
      tab_footnote(
  ...
  if (any(subset$Coverage < 0.93 | subset$Coverage > 0.979, na.rm = TRUE)) {
    gt_table <- gt_table %>%
      data_color(
        columns = "Coverage",
        rows = .data$Coverage < 0.93 | .data$Coverage > 0.979,
        method = "numeric",
        palette = c("#193006", "white"),
        domain = c(0, 1)
      ) %>%
      tab_footnote(
...
subset_0.2_Even_Model_1_table |> gtsave(here("z2t_rilta_lta_tables", "2T_L_R_.200_Even_Model_1.png"), expand = 8)
knitr::include_graphics(here("z2t_rilta_lta_tables", "2T_L_R_.200_Even_Model_1.png"))
...
subset_0.2_Even_Model_2_table |> gtsave(here("z2t_rilta_lta_tables", "2T_L_R_.200_Even_Model_2.png"), expand = 8)
knitr::include_graphics(here("z2t_rilta_lta_tables", "2T_L_R_.200_Even_Model_2.png"))
...
subset_0.2_Even_Model_3_table |> gtsave(here("z2t_rilta_lta_tables", "2T_L_R_.200_Even_Model_3.png"), expand = 8)
knitr::include_graphics(here("z2t_rilta_lta_tables", "2T_L_R_.200_Even_Model_3.png"))
...
subset_0.2_uneven_Model_1_table |> gtsave(here("z2t_rilta_lta_tables", "2T_L_R_.200_Uneven_Model_1.png"), expand = 8)
knitr::include_graphics(here("z2t_rilta_lta_tables", "2T_L_R_.200_Uneven_Model_1.png"))
...
subset_0.2_uneven_Model_2_table |> gtsave(here("z2t_rilta_lta_tables", "2T_L_R_.200_Uneven_Model_2.png"), expand = 8)
knitr::include_graphics(here("z2t_rilta_lta_tables", "2T_L_R_.200_Uneven_Model_2.png"))
...
subset_0.2_uneven_Model_3_table |> gtsave(here("z2t_rilta_lta_tables", "2T_L_R_.200_Uneven_Model_3.png"), expand = 8)
knitr::include_graphics(here("z2t_rilta_lta_tables", "2T_L_R_.200_Uneven_Model_3.png"))
...
subset_0.8_Even_Model_1_table |> gtsave(here("z2t_rilta_lta_tables", "2T_L_R_.800_Even_Model_1.png"), expand = 8)
knitr::include_graphics(here("z2t_rilta_lta_tables", "2T_L_R_.800_Even_Model_1.png"))
...
subset_0.8_Even_Model_2_table |> gtsave(here("z2t_rilta_lta_tables", "2T_L_R_.800_Even_Model_2.png"), expand = 8)
knitr::include_graphics(here("z2t_rilta_lta_tables", "2T_L_R_.800_Even_Model_2.png"))
...
subset_0.8_Even_Model_3_table |> gtsave(here("z2t_rilta_lta_tables", "2T_L_R_.800_Even_Model_3.png"), expand = 8)
knitr::include_graphics(here("z2t_rilta_lta_tables", "2T_L_R_.800_Even_Model_3.png"))
...
subset_0.8_uneven_Model_1_table |> gtsave(here("z2t_rilta_lta_tables", "2T_L_R_.800_Uneven_Model_1.png"), expand = 8)
knitr::include_graphics(here("z2t_rilta_lta_tables", "2T_L_R_.800_Uneven_Model_1.png"))
...
subset_0.8_uneven_Model_2_table |> gtsave(here("z2t_rilta_lta_tables", "2T_L_R_.800_Uneven_Model_2.png"), expand = 8)
knitr::include_graphics(here("z2t_rilta_lta_tables", "2T_L_R_.800_Uneven_Model_2.png"))
...
subset_0.8_uneven_Model_3_table |> gtsave(here("z2t_rilta_lta_tables", "2T_L_R_.800_Uneven_Model_3.png"), expand = 8)
knitr::include_graphics(here("z2t_rilta_lta_tables", "2T_L_R_.800_Uneven_Model_3.png"))
