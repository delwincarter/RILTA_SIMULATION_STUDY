...
subtitle: "Study 2.4: RILTA Generated, RILTA Analyzed with 3 Classes and 2 Timepoints"
...
rilta_rilta_func <- function(N, TPs, mix) {
  ...
  MODELPOPULATION <- if (mix == 1) { 
    glue("	
      ...
      c2#2 on c1#2*1.793147;
       ...
       f by u11*.1 u12*.1 u13*.2 u14*1 u15*1.1 (p1-p5)
            u21*.1 u22*.1 u23*.2 u24*1 u25*1.1 (p1-p5);
        f@1;
        [f@0];
  ...
  MODELPOPULATION <- if (mix == 1) { 
    glue("	
      ...
      c2#2 on c1#2*1.793147;
       ...
       f by u11*.1 u12*.1 u13*.2 u14*3.5 u15*3.6 (p1-p5)
            u11*.1 u12*.1 u13*.2 u14*3.5 u15*3.6 (p1-p5);
        f@1;
        [f@0];
  ...
  MODELPOPULATION <- if (mix == 1) { 
    glue("	
      ...
      c2#2 on c1#2*1.793147;
       ...
       f by u11*.1 u12*.1 u13*.2 u14*7.3 u15*7.3 (p1-p5)
            u11*.1 u12*.1 u13*.2 u14*7.3 u15*7.3 (p1-p5);
        f@1;
        [f@0];
...
output_folder <- here('Simulations', 'STUDY_2', '4_RILTA_GEN_RILTA_ANALYZED')  # Adjust to your folder path
...
#### Step 5: Part 2 Create Columns from Filename
...
# Model 1: RILTA Generated, RILTA Analyzed
...
rilta_rilta_func <- function(N, TPs, mix, lambda, Adjusted_Replications_Needed) {
...
rilta_rilta_func2 <- function(N, TPs, mix, lambda, Adjusted_Replications_Needed) {
...
rilta_rilta_func3 <- function(N, TPs, mix, lambda, Adjusted_Replications_Needed) {
...
rilta_rilta_func4 <- function(N, TPs, mix, Adjusted_Replications_Needed) {
...
rilta_rilta_func5 <- function(N, TPs, mix, Adjusted_Replications_Needed) {
...
rilta_rilta_func6 <- function(N, TPs, mix, Adjusted_Replications_Needed) {
...
rilta_rilta_func7 <- function(N, TPs, mix, Adjusted_Replications_Needed) {
...
rilta_rilta_func8 <- function(N, TPs, mix, Adjusted_Replications_Needed) {
...
rilta_rilta_func9 <- function(N, TPs, mix, Adjusted_Replications_Needed) {
...
rilta_rilta_func10 <- function(N, TPs, mix, Adjusted_Replications_Needed) {
...
rilta_rilta_func11 <- function(N, TPs, mix, Adjusted_Replications_Needed) {
...
rilta_rilta_func12 <- function(N, TPs, mix, Adjusted_Replications_Needed) {
