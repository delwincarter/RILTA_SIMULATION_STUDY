...
rilta_rilta_func <- function(N, TPs, mix, lambda) {
  ...
  RILTA_RILTA_Model<- mplusModeler(RILTA_RILTA, 
                                   dataout = here("4_RILTA_GEN_RILTA_ANLZE", glue("RILTA_RILTA_M1_N_{N}_TP_{TPs}_M_{mix}_L_{lambda}.dat")),
                                   modelout = glue(here("4_RILTA_GEN_RILTA_ANLZE", "RILTA_RILTA_M1_N_{N}_TP_{TPs}_M_{mix}_L_{lambda}.inp")),
...
rilta_rilta_func2 <- function(N, TPs, mix, lambda) {
  ...
  RILTA_RILTA_Model2<- mplusModeler(RILTA_RILTA2, 
                                   dataout = here("4_RILTA_GEN_RILTA_ANLZE", glue("RILTA_RILTA_M2_N_{N}_TP_{TPs}_M_{mix}_L_{lambda}.dat")),
                                   modelout = glue(here("4_RILTA_GEN_RILTA_ANLZE", "RILTA_RILTA_M2_N_{N}_TP_{TPs}_M_{mix}_L_{lambda}.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
...
rilta_rilta_func3 <- function(N, TPs, mix, lambda) {
  ...
  RILTA_RILTA_Model3<- mplusModeler(RILTA_RILTA3, 
                                   dataout = here("4_RILTA_GEN_RILTA_ANLZE", glue("RILTA_RILTA_M3_N_{N}_TP_{TPs}_M_{mix}_L_{lambda}.dat")),
                                   modelout = glue(here("4_RILTA_GEN_RILTA_ANLZE", "RILTA_RILTA_M3_N_{N}_TP_{TPs}_M_{mix}_L_{lambda}.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
...
RILTA_RILTA_func4 <- function(N, TPs, mix) {
  ...
  RILTA_RILTA_Model4<- mplusModeler(RILTA_RILTA4, 
                                   dataout = here("4_RILTA_GEN_RILTA_ANLZE", glue("RILTA_RILTA_M1_N_{N}_TP_{TPs}_M_{mix}_L_X.dat")),
                                   modelout = glue(here("4_RILTA_GEN_RILTA_ANLZE", "RILTA_RILTA_M1_N_{N}_TP_{TPs}_M_{mix}_L_X.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
...
RILTA_RILTA_func5 <- function(N, TPs, mix) {
  ...
  RILTA_RILTA_Model5<- mplusModeler(RILTA_RILTA5, 
                                   dataout = here("4_RILTA_GEN_RILTA_ANLZE", glue("RILTA_RILTA_M1_N_{N}_TP_{TPs}_M_{mix}_L_Y.dat")),
                                   modelout = glue(here("4_RILTA_GEN_RILTA_ANLZE", "RILTA_RILTA_M1_N_{N}_TP_{TPs}_M_{mix}_L_Y.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
...
RILTA_RILTA_func6 <- function(N, TPs, mix) {
  ...
  RILTA_RILTA_Model6<- mplusModeler(RILTA_RILTA6, 
                                   dataout = here("4_RILTA_GEN_RILTA_ANLZE", glue("RILTA_RILTA_M1_N_{N}_TP_{TPs}_M_{mix}_L_Z.dat")),
                                   modelout = glue(here("4_RILTA_GEN_RILTA_ANLZE", "RILTA_RILTA_M1_N_{N}_TP_{TPs}_M_{mix}_L_Z.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
...
RILTA_RILTA_func7 <- function(N, TPs, mix) {
  ...
  RILTA_RILTA_Model7<- mplusModeler(RILTA_RILTA7, 
                                   dataout = here("4_RILTA_GEN_RILTA_ANLZE", glue("RILTA_RILTA_M2_N_{N}_TP_{TPs}_M_{mix}_L_X.dat")),
                                   modelout = glue(here("4_RILTA_GEN_RILTA_ANLZE", "RILTA_RILTA_M2_N_{N}_TP_{TPs}_M_{mix}_L_X.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
...
RILTA_RILTA_func8 <- function(N, TPs, mix) {
  ...
  RILTA_RILTA_Model8<- mplusModeler(RILTA_RILTA8, 
                                   dataout = here("4_RILTA_GEN_RILTA_ANLZE", glue("RILTA_RILTA_M2_N_{N}_TP_{TPs}_M_{mix}_L_Y.dat")),
                                   modelout = glue(here("4_RILTA_GEN_RILTA_ANLZE", "RILTA_RILTA_M2_N_{N}_TP_{TPs}_M_{mix}_L_Y.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
...
RILTA_RILTA_func9 <- function(N, TPs, mix) {
  ...
  RILTA_RILTA_Model9<- mplusModeler(RILTA_RILTA9, 
                                   dataout = here("4_RILTA_GEN_RILTA_ANLZE", glue("RILTA_RILTA_M2_N_{N}_TP_{TPs}_M_{mix}_L_Z.dat")),
                                   modelout = glue(here("4_RILTA_GEN_RILTA_ANLZE", "RILTA_RILTA_M2_N_{N}_TP_{TPs}_M_{mix}_L_Z.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
...
RILTA_RILTA_func10 <- function(N, TPs, mix) {
  ...
  RILTA_RILTA_Model10<- mplusModeler(RILTA_RILTA10, 
                                   dataout = here("4_RILTA_GEN_RILTA_ANLZE", glue("RILTA_RILTA_M3_N_{N}_TP_{TPs}_M_{mix}_L_X.dat")),
                                   modelout = glue(here("4_RILTA_GEN_RILTA_ANLZE", "RILTA_RILTA_M3_N_{N}_TP_{TPs}_M_{mix}_L_X.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
...
RILTA_RILTA_func11 <- function(N, TPs, mix) {
  ...
  RILTA_RILTA_Model11<- mplusModeler(RILTA_RILTA11, 
                                   dataout = here("4_RILTA_GEN_RILTA_ANLZE", glue("RILTA_RILTA_M3_N_{N}_TP_{TPs}_M_{mix}_L_Y.dat")),
                                   modelout = glue(here("4_RILTA_GEN_RILTA_ANLZE", "RILTA_RILTA_M3_N_{N}_TP_{TPs}_M_{mix}_L_Y.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
...
RILTA_RILTA_func12 <- function(N, TPs, mix) {
  ...
  RILTA_RILTA_Model12<- mplusModeler(RILTA_RILTA12, 
                                   dataout = here("4_RILTA_GEN_RILTA_ANLZE", glue("RILTA_RILTA_M3_N_{N}_TP_{TPs}_M_{mix}_L_Z.dat")),
                                   modelout = glue(here("4_RILTA_GEN_RILTA_ANLZE", "RILTA_RILTA_M3_N_{N}_TP_{TPs}_M_{mix}_L_Z.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
...
csv_directory <- here('4_RILTA_GEN_RILTA_ANALYZED')
...
rilta_rilta_func <- function(N_numeric, TPs, Lambda, Mix, Adjusted_Replications_Needed) {
  ...
  # Run Mplus model
  RILTA_RILTA_Model<- mplusModeler(RILTA_RILTA, 
                                   dataout = here("4_RILTA_GEN_RILTA_ANLZE_REP", glue("RILTA_RILTA_M1_N_{N}_TP_{TPs}_M_{Mix}_L_{Lambda}.dat")),
                                   modelout = glue(here("4_RILTA_GEN_RILTA_ANLZE_REP", "RILTA_RILTA_M1_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_{Lambda}.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
return(RILTA_RILTA_Model)
}
...
rilta_rilta_func2 <- function(N_numeric, TPs, Lambda, Mix, Adjusted_Replications_Needed) {
  ...
  # Run Mplus model
  RILTA_RILTA_Model2<- mplusModeler(RILTA_RILTA2, 
                                   dataout = here("4_RILTA_GEN_RILTA_ANLZE_REP", glue("RILTA_RILTA_M2_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_{Lambda}.dat")),
                                   modelout = glue(here("4_RILTA_GEN_RILTA_ANLZE_REP", "RILTA_RILTA_M2_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_{Lambda}.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
return(RILTA_RILTA_Model2)
}
...
rilta_rilta_func3 <- function(N_numeric, TPs, Lambda, Mix, Adjusted_Replications_Needed) {
  ...
  # Run Mplus model
  RILTA_RILTA_Model3<- mplusModeler(RILTA_RILTA3, 
                                   dataout = here("4_RILTA_GEN_RILTA_ANLZE_REP", glue("RILTA_RILTA_M3_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_{Lambda}.dat")),
                                   modelout = glue(here("4_RILTA_GEN_RILTA_ANLZE_REP", "RILTA_RILTA_M3_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_{Lambda}.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
return(RILTA_RILTA_Model3)
}
...
rilta_rilta_func4 <- function(N_numeric, TPs, Mix, Adjusted_Replications_Needed) {
  ...
  # Run Mplus model
  RILTA_RILTA_Model4<- mplusModeler(RILTA_RILTA4, 
                                   dataout = here("4_RILTA_GEN_RILTA_ANLZE_REP", glue("RILTA_RILTA_M1_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_X.dat")),
                                   modelout = glue(here("4_RILTA_GEN_RILTA_ANLZE_REP", "RILTA_RILTA_M1_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_X.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
return(RILTA_RILTA_Model4)
}
...
rilta_rilta_func5 <- function(N_numeric, TPs, Mix, Adjusted_Replications_Needed) {
  ...
  # Run Mplus model
  RILTA_RILTA_Model5<- mplusModeler(RILTA_RILTA5, 
                                   dataout = here("4_RILTA_GEN_RILTA_ANLZE_REP", glue("RILTA_RILTA_M1_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_Y.dat")),
                                   modelout = glue(here("4_RILTA_GEN_RILTA_ANLZE_REP", "RILTA_RILTA_M1_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_Y.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
return(RILTA_RILTA_Model5)
}
...
rilta_rilta_func6 <- function(N_numeric, TPs, Mix, Adjusted_Replications_Needed) {
  ...
  # Run Mplus model
  RILTA_RILTA_Model6<- mplusModeler(RILTA_RILTA6, 
                                   dataout = here("4_RILTA_GEN_RILTA_ANLZE_REP", glue("RILTA_RILTA_M1_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_Z.dat")),
                                   modelout = glue(here("4_RILTA_GEN_RILTA_ANLZE_REP", "RILTA_RILTA_M1_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_Z.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
return(RILTA_RILTA_Model6)
}
...
rilta_rilta_func7 <- function(N_numeric, TPs, Mix, Adjusted_Replications_Needed) {
  ...
  # Run Mplus model
  RILTA_RILTA_Model7<- mplusModeler(RILTA_RILTA7, 
                                   dataout = here("4_RILTA_GEN_RILTA_ANLZE_REP", glue("RILTA_RILTA_M2_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_X.dat")),
                                   modelout = glue(here("4_RILTA_GEN_RILTA_ANLZE_REP", "RILTA_RILTA_M2_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_X.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
return(RILTA_RILTA_Model7)
}
...
rilta_rilta_func8 <- function(N_numeric, TPs, Mix, Adjusted_Replications_Needed) {
  ...
  # Run Mplus model
  RILTA_RILTA_Model8<- mplusModeler(RILTA_RILTA8, 
                                   dataout = here("4_RILTA_GEN_RILTA_ANLZE_REP", glue("RILTA_RILTA_M2_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_Y.dat")),
                                   modelout = glue(here("4_RILTA_GEN_RILTA_ANLZE_REP", "RILTA_RILTA_M2_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_Y.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
return(RILTA_RILTA_Model8)
}
...
rilta_rilta_func9 <- function(N_numeric, TPs, Mix, Adjusted_Replications_Needed) {
  ...
  # Run Mplus model
  RILTA_RILTA_Model9<- mplusModeler(RILTA_RILTA9, 
                                   dataout = here("4_RILTA_GEN_RILTA_ANLZE_REP", glue("RILTA_RILTA_M2_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_Z.dat")),
                                   modelout = glue(here("4_RILTA_GEN_RILTA_ANLZE_REP", "RILTA_RILTA_M2_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_Z.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
return(RILTA_RILTA_Model9)
}
...
rilta_rilta_func10 <- function(N_numeric, TPs, Mix, Adjusted_Replications_Needed) {
  ...
  # Run Mplus model
  RILTA_RILTA_Model10<- mplusModeler(RILTA_RILTA10, 
                                   dataout = here("4_RILTA_GEN_RILTA_ANLZE_REP", glue("RILTA_RILTA_M3_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_X.dat")),
                                   modelout = glue(here("4_RILTA_GEN_RILTA_ANLZE_REP", "RILTA_RILTA_M3_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_X.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
return(RILTA_RILTA_Model10)
}
...
rilta_rilta_func11 <- function(N_numeric, TPs, Mix, Adjusted_Replications_Needed) {
  ...
  # Run Mplus model
  RILTA_RILTA_Model11<- mplusModeler(RILTA_RILTA11, 
                                   dataout = here("4_RILTA_GEN_RILTA_ANLZE_REP", glue("RILTA_RILTA_M3_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_Y.dat")),
                                   modelout = glue(here("4_RILTA_GEN_RILTA_ANLZE_REP", "RILTA_RILTA_M3_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_Y.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
return(RILTA_RILTA_Model11)
}
...
rilta_rilta_func12 <- function(N_numeric, TPs, Mix, Adjusted_Replications_Needed) {
  ...
  # Run Mplus model
  RILTA_RILTA_Model12<- mplusModeler(RILTA_RILTA12, 
                                   dataout = here("4_RILTA_GEN_RILTA_ANLZE_REP", glue("RILTA_RILTA_M3_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_Z.dat")),
                                   modelout = glue(here("4_RILTA_GEN_RILTA_ANLZE_REP", "RILTA_RILTA_M3_N_{N_numeric}_TP_{TPs}_M_{Mix}_L_Z.inp")),
                                   check = TRUE, run = TRUE, hashfilename = FALSE)
return(RILTA_RILTA_Model12)
}
...
# Step 1: Set the correct CSV directory
csv_directory <- here('4_RILTA_GEN_RILTA_ANLZE_REP')
...
create_bias_plot <- function(data, title, ylim_range) {
  ...
  ggplot(data, aes(x = factor(N))) +  
    ...
    geom_point(aes(y = Parameter_Bias, color = "Parameter Bias"), shape = 16, size = 1.7, fill = "#4169E1", alpha = 1) +  
    geom_point(aes(y = SE_Bias, color = "Standard Error Bias"), shape = 18, size = 2.5, fill = "#E14169", alpha = 1) +  
    geom_point(data = subset(data, Coverage_Dic == 0), aes(y = Parameter_Bias, color = "Coverage Failure"), shape = 1, size = 3, fill = "#4169E1", alpha = 1) +  
  ...
  if (any(!(subset$Parameter_Bias >= -9.99 & subset$Parameter_Bias <= 9.99), na.rm = TRUE)) {
    gt_table <- gt_table %>%
      data_color(
        ...
        method = "numeric",
        palette = c("#1f78b4", "#deebf7", "#1f78b4"),  # Darker blue for larger deviations
  ...
  if (any(!(subset$SE_Bias >= -4.99 & subset$SE_Bias <= 4.99), na.rm = TRUE)) {
    gt_table <- gt_table %>%
      data_color(
        ...
        method = "numeric",
        palette = c("#e31a1c", "#fde0dd", "#e31a1c"),  # Darker red for larger deviations
  ...
  if (any(subset$Coverage < 0.93 | subset$Coverage > 0.979, na.rm = TRUE)) {
    gt_table <- gt_table %>%
      data_color(
        ...
        method = "numeric",
        palette = c("#193006", "white"),  # Green for coverage issues
        domain = c(0, 1)
      ) %>%
      tab_footnote(
  ...
  if (any(subset$Power < 0.8, na.rm = TRUE)) {
    gt_table <- gt_table %>%
      data_color(
        ...
        method = "numeric",
        palette = c("#300049", "white"),  # Purple for power issues
        domain = c(0, 1)
      ) %>%
      tab_footnote(
...
subset_02_table_even_proportions |> tab_options(table.width = pct(55)) |> gtsave(here("z2t_lta_rilta_tables", "2T_L_R_.200, Even Proportions.png"), expand = 8)
```
...
subset_0.2_table_uneven_proportions |> tab_options(table.width = pct(55)) |> gtsave(here("z2t_lta_rilta_tables","2T_L_R_.200, Uneven Proportions.png"), expand = 8)
```
...
subset_0.8_table_even_proportions |> tab_options(table.width = pct(55)) |> gtsave(here("z2t_lta_rilta_tables", "2T_L_R_.800, Even Proportions.png"), expand = 8)
```
...
subset_0.8_table_uneven_proportions |> tab_options(table.width = pct(55)) |> gtsave(here("z2t_lta_rilta_tables", "2T_L_R_.800, Uneven Proportions.png"), expand = 8)
```

# OLD OUTPUT FILE DATA WRANGLING

```{r}
# Extract models
lta_sim <- readModels(here("4_RILTA_GEN_RILTA_ANLZE"), what = "parameters")
...
lta_combined$Class_Definition <- rep(c("1", "2"), each = 1)
lta_combined$Threshold <- rep(c("3", "2", "1"), each = 2)
#lta_comined_N <- rep(c("1", "2", "3", "4"), each = 6)
lta_combined <- lta_combined %>%
  mutate(N = rep(1:4, each = 72)) %>%
  mutate(Cond_Num = as.array(rep(1:288)))


# Define the labels
#labels <- c(
 # expression(italic('N') ~ "= 1000"),
  #expression(italic('N') ~ "= 2500"),
  #expression(italic('N') ~ "= 5000"),
  #expression(italic('N') ~ "= 7500")

# Modify the N variable in the dataset
lta_combined$N <- factor(lta_combined$N, levels = 1:4, labels = c("N = 1000", "N = 2500", "N = 5000", "N = 7500"))
#levels(lta_combined$N) <- c(expression(italic(N) ~ "= 1000"),
 #                          expression(italic(N) ~ "= 2500"),
  #                         expression(italic(N) ~ "= 5000"),
   #                        expression(italic(N) ~ "= 7500"))
lta_combined <- lta_combined %>%
  arrange(population, Threshold, Class_Definition)
 


lta_combined$CDxT <- rep(c("1", "2", "3"), each = 48)

lta_combined$CDxT <- factor(lta_combined$CDxT, 
                             levels = c("1", "2", "3"),
                             labels = c("Small Thresholds", "Moderate Thresholds", "Large Thresholds"))


lta_combined$CD_row_Labels <- ifelse(lta_combined$Class_Definition == 1, "Well Defined Models", "Poorly Defined Models")
...
lambda_values <- c(0,	1, 1.5, 2, 2.5, 3,
                   0,	1, 1.5, 2, 2.5, 3,
                   0,	1, 1.5, 2, 2.5, 3,
                   0,	1, 1.5, 2, 2.5, 3,
                   0,	1, 1.5, 2, 2.5, 3,
...
# Repeat the lambda values to match the length of the dataframe
num_repeats <- nrow(lta_combined) / length(lambda_values) / 8
lta_combined$Lambda <- rep(lambda_values, each = num_repeats)


#subset_0.2$CD_row_Labels <- factor(subset_0.2$CD_row_Labels, levels = c("Well Defined Models", "Poorly Defined Models"))

# Subset for Well Defined Models
subset_well <- subset(lta_combined, Class_Definition == 1)
# Subset for Poorly Defined Models
subset_poor <- subset(lta_combined, Class_Definition == 2)

# Subset for population 0.2 Well Defined Models
subset_0.2WD <- subset(subset_well, population == 0.2)
# Subset for population 0.2 Poorly Defined Models
subset_0.2PD <- subset(subset_poor, population == 0.2)
# Subset for population 0.8 Well Defined Models
subset_0.8WD <- subset(subset_well, population == 0.8)
# Subset for population 0.8 Poorly Defined Models
subset_0.8PD <- subset(subset_poor, population == 0.8)
...
common_labels <- labs(
  ...
  y = "Bias (%)",
  color = "",
  title = "Well Defined Models with .2 Transition Probabilites"
)



# Plotting
plot_0.2WD <- ggplot(data = subset_0.2WD, aes(x = factor(Lambda))) +  
  ...
  geom_point(data = subset(subset_0.2WD, Coverage_Dic == 0), aes(y = Parameter_Bias, color = "Coverage Failure"), shape = 1, size = 2, fill = "#4169E1", alpha = 1) +  
  geom_point(data = subset(subset_0.2WD, Power_Dic == 0), aes(y = Parameter_Bias, color = "Power Failure"), shape = 4, size = 2, fill = "black", alpha = 1) + 
  scale_color_manual(
    ...
    guide = guide_legend(
      override.aes = list(
        shape = c(16, 18, 1, 4)  # Circle, diamond, circle, X
      )
    )
  ) + 
  common_labels +
  coord_cartesian(ylim = c(-40, 40)) +  
  facet_grid(factor(CDxT) ~ N, scales = "free_x") + 
  scale_x_discrete(name = "Lambda Loadings on the RI") +  # Set x-axis title
  scale_y_continuous(breaks = seq(-40, 40, by = 10)) +  
  common_theme +
  geom_hline(yintercept = c(-10, 10), linetype = "dashed", color = "#4169E1", size = 0.3) +  
  geom_hline(yintercept = c(-5, 5), linetype = "dashed", color = "#E14169", size = 0.3) +
...
common_labels <- labs(
  ...
  y = "Bias (%)",
  color = "",
  title = "Poorly Defined Models with .2 Transition Probabilites"
)



# Plotting
plot_0.2PD <- ggplot(data = subset_0.2PD, aes(x = factor(Lambda))) +  
  geom_line(aes(y = Parameter_Bias, color = "Parameter Bias", group = 1), size = 0.3, linetype = "solid") +  
  geom_line(aes(y = SE_Bias, color = "Standard Error Bias", group = 1), size = 0.3, linetype = "solid") +  
  geom_point(aes(y = Parameter_Bias, color = "Parameter Bias"), shape = 16, size = 1, fill = "#4169E1", alpha = 0.8) +  
  geom_point(aes(y = SE_Bias, color = "Standard Error Bias"), shape = 18, size = 1, fill = "#E14169", alpha = 0.8) +  
  geom_point(data = subset(subset_0.2PD, Coverage_Dic == 0), aes(y = Parameter_Bias, color = "Coverage Failure"), shape = 1, size = 2, fill = "#4169E1", alpha = 1) +  
  geom_point(data = subset(subset_0.2PD, Power_Dic == 0), aes(y = Parameter_Bias, color = "Power Failure"), shape = 4, size = 2, fill = "black", alpha = 1) + 
  scale_color_manual(
    values = c("Parameter Bias" = "#4169E1", "Standard Error Bias" = "#E14169", "Coverage Failure" = "#4169E1", "Power Failure" = "black"), 
    labels = c("Parameter Bias", "Standard Error Bias", "Coverage Failure", "Power Failure"), 
    breaks = c("Parameter Bias", "Standard Error Bias", "Coverage Failure", "Power Failure"),
  ...
  facet_grid(factor(CDxT) ~ N, scales = "free_x") + 
  scale_x_discrete(name = "Lambda Loadings on the RI") +  # Set x-axis title
  scale_y_continuous(breaks = seq(-50, 40, by = 10)) +  
  common_theme +
  geom_hline(yintercept = c(-10, 10), linetype = "dashed", color = "#4169E1", size = 0.3) +  
  geom_hline(yintercept = c(-5, 5), linetype = "dashed", color = "#E14169", size = 0.3) +
  theme(strip.text.y = element_text(size = 8))  # Adjust the size of row titles
...
common_labels <- labs(
  ...
  y = "Bias (%)",
  color = "",
  title = "Well Defined Models with .8 Transition Probabilites"
)



# Plotting
plot_0.8WD <- ggplot(data = subset_0.8WD, aes(x = factor(Lambda))) +  
  geom_line(aes(y = Parameter_Bias, color = "Parameter Bias", group = 1), size = 0.3, linetype = "solid") +  
  geom_line(aes(y = SE_Bias, color = "Standard Error Bias", group = 1), size = 0.3, linetype = "solid") +  
  geom_point(aes(y = Parameter_Bias, color = "Parameter Bias"), shape = 16, size = 1, fill = "#4169E1", alpha = 0.8) +  
  geom_point(aes(y = SE_Bias, color = "Standard Error Bias"), shape = 18, size = 1, fill = "#E14169", alpha = 0.8) +  
  geom_point(data = subset(subset_0.8WD, Coverage_Dic == 0), aes(y = Parameter_Bias, color = "Coverage Failure"), shape = 1, size = 2, fill = "#4169E1", alpha = 1) +  
  geom_point(data = subset(subset_0.8WD, Power_Dic == 0), aes(y = Parameter_Bias, color = "Power Failure"), shape = 4, size = 2, fill = "black", alpha = 1) + 
  scale_color_manual(
    values = c("Parameter Bias" = "#4169E1", "Standard Error Bias" = "#E14169", "Coverage Failure" = "#4169E1", "Power Failure" = "black"), 
    labels = c("Parameter Bias", "Standard Error Bias", "Coverage Failure", "Power Failure"), 
    breaks = c("Parameter Bias", "Standard Error Bias", "Coverage Failure", "Power Failure"),
...
common_labels <- labs(
  ...
  y = "Bias (%)",
  color = "",
  title = "Poorly Defined Models with .8 Transition Probabilites"
)



# Plotting
plot_0.8PD <- ggplot(data = subset_0.8PD, aes(x = factor(Lambda))) +  
  geom_line(aes(y = Parameter_Bias, color = "Parameter Bias", group = 1), size = 0.3, linetype = "solid") +  
  geom_line(aes(y = SE_Bias, color = "Standard Error Bias", group = 1), size = 0.3, linetype = "solid") +  
  geom_point(aes(y = Parameter_Bias, color = "Parameter Bias"), shape = 16, size = 1, fill = "#4169E1", alpha = 0.8) +  
  geom_point(aes(y = SE_Bias, color = "Standard Error Bias"), shape = 18, size = 1, fill = "#E14169", alpha = 0.8) +  
  geom_point(data = subset(subset_0.8PD, Coverage_Dic == 0), aes(y = Parameter_Bias, color = "Coverage Failure"), shape = 1, size = 2, fill = "#4169E1", alpha = 1) +  
  geom_point(data = subset(subset_0.8PD, Power_Dic == 0), aes(y = Parameter_Bias, color = "Power Failure"), shape = 4, size = 2, fill = "black", alpha = 1) + 
  scale_color_manual(
    values = c("Parameter Bias" = "#4169E1", "Standard Error Bias" = "#E14169", "Coverage Failure" = "#4169E1", "Power Failure" = "black"), 
    labels = c("Parameter Bias", "Standard Error Bias", "Coverage Failure", "Power Failure"), 
    breaks = c("Parameter Bias", "Standard Error Bias", "Coverage Failure", "Power Failure"),
...
all_data <- lta_combined %>% 
  mutate(population = factor(population,
                             labels = c(`.2`= ".200", `.8` = ".800")))

rownames(all_data) <- NULL

# Define necessary subsets
subset_0.2_well_defined <- all_data %>%
  filter(population == ".200", CD_row_Labels == "Well Defined Models")

subset_0.2_poorly_defined <- all_data %>%
  filter(population == ".200", CD_row_Labels == "Poorly Defined Models")

subset_0.8_well_defined <- all_data %>%
  filter(population == ".800", CD_row_Labels == "Well Defined Models")

subset_0.8_poorly_defined <- all_data %>%
  filter(population == ".800", CD_row_Labels == "Poorly Defined Models")

subset_0.2_well_defined_small <- subset_0.2_well_defined %>%
  filter(CDxT == "Small Thresholds")

subset_0.2_well_defined_moderate <- subset_0.2_well_defined %>%
  filter(CDxT == "Moderate Thresholds")

subset_0.2_well_defined_large <- subset_0.2_well_defined %>%
  filter(CDxT == "Large Thresholds")

subset_0.2_poorly_defined_small <- subset_0.2_poorly_defined %>%
  filter(CDxT == "Small Thresholds")

subset_0.2_poorly_defined_moderate <- subset_0.2_poorly_defined %>%
  filter(CDxT == "Moderate Thresholds")

subset_0.2_poorly_defined_large <- subset_0.2_poorly_defined %>%
  filter(CDxT == "Large Thresholds")

subset_0.8_well_defined_small <- subset_0.8_well_defined %>%
  filter(CDxT == "Small Thresholds")

subset_0.8_well_defined_moderate <- subset_0.8_well_defined %>%
  filter(CDxT == "Moderate Thresholds")

subset_0.8_well_defined_large <- subset_0.8_well_defined %>%
  filter(CDxT == "Large Thresholds")

subset_0.8_poorly_defined_small <- subset_0.8_poorly_defined %>%
  filter(CDxT == "Small Thresholds")

subset_0.8_poorly_defined_moderate <- subset_0.8_poorly_defined %>%
  filter(CDxT == "Moderate Thresholds")

subset_0.8_poorly_defined_large <- subset_0.8_poorly_defined %>%
  filter(CDxT == "Large Thresholds")

subset_0.2_well_defined_small <- subset_0.2_well_defined_small %>%
  select(Lambda, average, Coverage, Power, Parameter_Bias, SE_Bias)

subset_0.2_well_defined_moderate <- subset_0.2_well_defined_moderate %>%
  select(Lambda, average, Coverage, Power, Parameter_Bias, SE_Bias)

subset_0.2_well_defined_large <- subset_0.2_well_defined_large %>%
  select(Lambda, average, Coverage, Power, Parameter_Bias, SE_Bias)

subset_0.2_poorly_defined_small <- subset_0.2_poorly_defined_small %>%
  select(Lambda, average, Coverage, Power, Parameter_Bias, SE_Bias)

subset_0.2_poorly_defined_moderate <- subset_0.2_poorly_defined_moderate %>%
  select(Lambda, average, Coverage, Power, Parameter_Bias, SE_Bias)

subset_0.2_poorly_defined_large <- subset_0.2_poorly_defined_large %>%
  select(Lambda, average, Coverage, Power, Parameter_Bias, SE_Bias)

subset_0.8_well_defined_small <- subset_0.8_well_defined_small %>%
  select(Lambda, average, Coverage, Power, Parameter_Bias, SE_Bias)

subset_0.8_well_defined_moderate <- subset_0.8_well_defined_moderate %>%
  select(Lambda, average, Coverage, Power, Parameter_Bias, SE_Bias)

subset_0.8_well_defined_large <- subset_0.8_well_defined_large %>%
  select(Lambda, average, Coverage, Power, Parameter_Bias, SE_Bias)

subset_0.8_poorly_defined_small <- subset_0.8_poorly_defined_small %>%
  select(Lambda, average, Coverage, Power, Parameter_Bias, SE_Bias)

subset_0.8_poorly_defined_moderate <- subset_0.8_poorly_defined_moderate %>%
  select(Lambda, average, Coverage, Power, Parameter_Bias, SE_Bias)

subset_0.8_poorly_defined_large <- subset_0.8_poorly_defined_large %>%
  select(Lambda, average, Coverage, Power, Parameter_Bias, SE_Bias)
...
create_table <- function(subset, transition_probability) {
  ...
  gt_table <- subset %>%
    ...
    tab_row_group(
      label = "N = 7500", 
      rows = c(19:24)  # Rows corresponding to the fourth subgroup
    ) %>%
    tab_row_group(
      label = "N = 5000",  # Label for the fifth subgroup
      rows = c(13:18)  # Rows corresponding to the fifth subgroup
    ) %>%
    tab_row_group(
      label = "N = 2500",  # Label for the sixth subgroup
      rows = c(7:12)  # Rows corresponding to the sixth subgroup
    ) %>%
    tab_row_group(
      label = "N = 1000",  # Label for the sixth subgroup
      rows = c(1:6)  # Rows corresponding to the sixth subgroup
    ) %>%
    tab_style(
      style = cell_text(
...
subset_0.2_well_defined_small_table <- create_table(subset_0.2_well_defined_small, ".200, Well Defined, Small Thresholds")
subset_0.2_well_defined_small_table
subset_0.2_well_defined_small_table |> tab_options(table.width = pct(55)) |> gtsave("2T_R_R_.200, Well Defined, Small Thresholds.png", expand = 8)
```

```{r}
subset_0.2_well_defined_moderate_table <- create_table(subset_0.2_well_defined_moderate, ".200, Well Defined, Moderate Thresholds")
subset_0.2_well_defined_moderate_table
subset_0.2_well_defined_moderate_table |> tab_options(table.width = pct(55)) |> gtsave("2T_R_R_.200, Well Defined, Moderate Thresholds.png", expand = 8)
```

```{r}
subset_0.2_well_defined_large_table <- create_table(subset_0.2_well_defined_large, ".200, Well Defined, Large Thresholds")
subset_0.2_well_defined_large_table
subset_0.2_well_defined_large_table |> tab_options(table.width = pct(55)) |> gtsave("2T_R_R_.200, Well Defined, Large Thresholds.png", expand = 8)
```

```{r}
subset_0.2_poorly_defined_small_table <- create_table(subset_0.2_poorly_defined_small, ".200, Poorly Defined, Small Thresholds")
subset_0.2_poorly_defined_small_table
subset_0.2_poorly_defined_small_table |> tab_options(table.width = pct(55)) |> gtsave("2T_R_R_.200, Poorly Defined, Small Thresholds.png", expand = 8)
```

```{r}
subset_0.2_poorly_defined_moderate_table <- create_table(subset_0.2_poorly_defined_moderate, ".200, Poorly Defined, Moderate Thresholds")
subset_0.2_poorly_defined_moderate_table
subset_0.2_poorly_defined_moderate_table |> tab_options(table.width = pct(55)) |> gtsave("2T_R_R_.200, Poorly Defined, Moderate Thresholds.png", expand = 8)
```

```{r}
subset_0.2_poorly_defined_large_table <- create_table(subset_0.2_poorly_defined_large, ".200, Poorly Defined, Large Thresholds")
subset_0.2_poorly_defined_large_table
subset_0.2_poorly_defined_large_table |> tab_options(table.width = pct(55)) |> gtsave("2T_R_R_.200, Poorly Defined, Large Thresholds.png", expand = 8)
```

```{r}
subset_0.8_well_defined_small_table <- create_table(subset_0.8_well_defined_small, ".800, Well Defined, Small Thresholds")
subset_0.8_well_defined_small_table
subset_0.8_well_defined_small_table |> tab_options(table.width = pct(55)) |> gtsave("2T_R_R_.800, Well Defined, Small Thresholds.png", expand = 8)
```

```{r}
subset_0.8_well_defined_moderate_table <- create_table(subset_0.8_well_defined_moderate, ".800, Well Defined, Moderate Thresholds")
subset_0.8_well_defined_moderate_table
subset_0.8_well_defined_moderate_table |> tab_options(table.width = pct(55)) |> gtsave("2T_R_R_.800, Well Defined, Moderate Thresholds.png", expand = 8)
```

```{r}
subset_0.8_well_defined_large_table <- create_table(subset_0.8_well_defined_large, ".800, Well Defined, Large Thresholds")
subset_0.8_well_defined_large_table
subset_0.8_well_defined_large_table |> tab_options(table.width = pct(55)) |> gtsave("2T_R_R_.800, Well Defined, Large Thresholds.png", expand = 8)
```

```{r}
subset_0.8_poorly_defined_small_table <- create_table(subset_0.8_poorly_defined_small, ".800, Poorly Defined, Small Thresholds")
subset_0.8_poorly_defined_small_table
subset_0.8_poorly_defined_small_table |> tab_options(table.width = pct(55)) |> gtsave("2T_R_R_.800, Poorly Defined, Small Thresholds.png", expand = 8)
```

```{r}
subset_0.8_poorly_defined_moderate_table <- create_table(subset_0.8_poorly_defined_moderate, ".800, Poorly Defined, Moderate Thresholds")
subset_0.8_poorly_defined_moderate_table
subset_0.8_poorly_defined_moderate_table |> tab_options(table.width = pct(55)) |> gtsave("2T_R_R_.800, Poorly Defined, Moderate Thresholds.png", expand = 8)
```

```{r}
subset_0.8_poorly_defined_large_table <- create_table(subset_0.8_poorly_defined_large, ".800, Poorly Defined, Large Thresholds")
subset_0.8_poorly_defined_large_table
subset_0.8_poorly_defined_large_table |> tab_options(table.width = pct(55)) |> gtsave("2T_R_R_.800, Poorly Defined, Large Thresholds.png", expand = 8)
```
