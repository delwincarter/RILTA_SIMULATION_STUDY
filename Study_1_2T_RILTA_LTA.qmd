...
rilta_lta_func <- function(N, TPs, TH, lamda) {
  ...
  RILTA_LTA_Model<- mplusModeler(RILTA_LTA, 
                                   dataout = here("4. 2T RILTA GEN LTA ANALYZED", glue("RILTA_LTA_N = {N}_TP = {TPs}_TH = {TH}_lamda = {lamda}.dat")),
                                   modelout = glue(here("4. 2T RILTA GEN LTA ANALYZED", "RILTA_LTA_N = {N}_TP = {TPs}_TH = {TH}_lamda = {lamda}.inp")),
...
```{r}
# Extract models
lta_sim <- readModels(here("4. 2T RILTA GEN LTA ANALYZED"), what = "parameters")
