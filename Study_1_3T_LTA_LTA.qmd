...
lta_lta_func <- function(N, TPs, TH) {
  ...
  LTA_LTA_Model<- mplusModeler(LTA_LTA, 
                                   dataout = here("5. 3T LTA GEN LTA ANALYZED", glue("LTA_LTA_N = {N}_TP = {TPs}_TH = {TH}_WD.dat")),
                                   modelout = glue(here("5. 3T LTA GEN LTA ANALYZED", "LTA_LTA_N = {N}_TP = {TPs}_TH = {TH}_WD.inp")),
